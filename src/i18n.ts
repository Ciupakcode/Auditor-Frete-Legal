...
export const translations = {
  pt: {
    ...
    scannerError: "Preencha a Placa, Distâncias e Valor do Frete antes de analisar a imagem.",
    ...
    btnSalvarPDF: "Salvar Relatório PDF",
    ...
    resCustosManutPneus: "• Pneus (50%)",
    resCustosManutOleo: "• Óleo e Filtros (20%)",
    resCustosManutPecas: "• Peças e Reparos (30%)",
    resCustosAdm: "Administrativo & Depreciação (12.06%)",
    resCustosAdmDeprec: "• Depreciação do Bem (70%)",
    resCustosAdmGestao: "• Seguros e Gestão (30%)",
  ...
  es: {
    ...
    scannerError: "Complete la Chapa, Distancias y Valor del Flete antes de escanear.",
    ...
    resCustosManutPneus: "• Neumáticos (50%)",
    resCustosManutOleo: "• Aceite y Filtros (20%)",
    resCustosManutPecas: "• Repuestos/Taller (30%)",
    resCustosAdm: "Administrativo & Depreciación (12.06%)",
    resCustosAdmDeprec: "• Depreciación Equipo (70%)",
    resCustosAdmGestao: "• Seguros y Gestión (30%)",

...
export const translations = {
  pt: {
    ...
    offlineDesc: "Alguns recursos como envio de denúncias requerem internet, mas os cálculos continuam funcionando.",
    ...
    resCustosDiesel: "Combustível (PPC) - 45,57%",
    resCustosManut: "Manutenção Total - 15,03%",
    resCustosManutPecas: "• Repostos (12,41%)",
    resCustosManutMaoObra: "• Mão de Obra (2,62%)",
    resCustosAdm: "Admin. & Depreciação - 12,06%",
    resCustosAdmDeprec: "• Aquisição/Depreciação (PPET) - 5,79%",
    resCustosAdmGestao: "• Administração (PPCA) - 6,27%",
    resCustosPedagios: "Pedágios (PPCP) - 8,21%",
    resCustosSalarios: "Condução Total - 19,13%",
    resCustosSalariosV: "• Condução (Variável) - 14,67%",
    resCustosSalariosF: "• Condução (Fixa) - 4,46%",
    resCustosEstadia: "Dias de Espera (Estadía >24h)",
    resCustosIva: "Reserva p/ Imposto (IVA 10%)",
  ...
  es: {
    ...
    offlineMode: "MODO OFFLINE",
    offlineDesc: "Algunas funciones, como el envío de denuncias, requieren internet, pero los cálculos siguen funcionando.",
    listaNegra: "Lista Negra",
    todos: "Todos",
